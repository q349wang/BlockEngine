...
class FaceTests {
	...
	void testMayIntersect2DTrue() {
		Perspective pov = new Perspective(new double[] { -10, 0, 0 }, new double[] { 1, 0, 0 },
				new double[] { 0, 1, 0 });
	...
	void testMayIntersect3DFalse() {
		Perspective pov = new Perspective(new double[] { -1, 0, 0 }, new double[] { 1, 0, 0 },
				new double[] { 0, 1, 0 });
		Position2D[] points1 = { new Position2D(0, 0), new Position2D(0, 10), new Position2D(10, 10),
				new Position2D(10, 0) };
		Plane plane1 = new Plane(new Vector3D(0, 1, 0), new Vector3D(0, 0, 1), new Position3D());
	...
	void testCompareTotallyInside() {
		...
		Perspective pov = new Perspective(new double[] { -8000, 0, 0 }, new double[] { 1, 0, 0 },
				new double[] { 0, -1, 0 });
		pov.setZoom(4000);
		Position2D[] points1 = { new Position2D(-500, -500), new Position2D(-500, 500), new Position2D(500, 500),
				new Position2D(500, -500) };
		Position2D[] points2 = { new Position2D(-1000, -1000), new Position2D(-1000, 1000), new Position2D(1000, 1000),
